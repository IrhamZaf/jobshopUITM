                                                ...
                                                <div id="jobQuoteCarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">" This job platform has transformed my career search experience! "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" I found my dream job here, highly recommend it! "</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" The support team is fantastic and always ready to help! "</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end carousel -->
